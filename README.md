...
Auth0 authentication for Laravel Nova

Add a screenshot of the tool here.

## Installation

[![Latest Version on Packagist](https://img.shields.io/packagist/v/opscale-co/nova-auth0.svg?style=flat-square)](https://packagist.org/packages/opscale-co/nova-auth0)

You can install the package in to a Laravel app that uses [Nova](https://nova.laravel.com) via composer:

```bash

composer require opscale-co/nova-auth0
...
Click on the "nova-auth0" menu item in your Nova app to see the tool provided by this package.
